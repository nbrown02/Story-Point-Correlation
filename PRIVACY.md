...
The Estimate Accuracy (Story Point Correlation) template for Jira/ADO template does **not**:
...
For any privacy-related inquiries, please open an issue in the repository: [GitHub Issues](https://github.com/nbrown02/Story-Point-Correlation/issues).
